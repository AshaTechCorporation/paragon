          ...
          children: [
            Padding(
              ...
              child: TextButton(
                ...
                child: Text(
                  'ยกเลิก',
                  style: TextStyle(fontSize: isPhone(context) ? 18 : 25, color: Colors.white),
                ),
              ),
            ),
            Padding(
      ...
      actions: [
        Center(
          child: TextButton(
            ...
            child: Text(
              'ตกลง',
              style: TextStyle(fontSize: isPhone(context) ? 18 : 28, fontWeight: FontWeight.bold, color: kButtoncolor),
            ),
          ),
        ),
      ],
